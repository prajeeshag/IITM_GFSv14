...
!! Jun 06 2016        Philip Pegion,  check attribute (import_flag) for coupling
!-----------------------------------------------------------------------
!
      USE ESMF
...
!
      integer                        :: rc,n
      integer(ESMF_KIND_I4)          :: import_flag
...
!
      data_3d: do n=1,ndata3o
        ...
        CALL ESMF_AttributeGet(imp_state,name=trim(array_name)//'_export',value=import_flag,rc=rc)
!         state export is coupler import
