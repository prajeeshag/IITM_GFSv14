...
!
      PUBLIC :: GFS_INITIALIZE, GFS_RUN, GFS_FINALIZE
!-----------------------------------------------------------------------
!
...
!
      ...
      use module_timers,only: initialize_timers
!------------------------
!***  Argument variables
!------------------------
!
...
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
      MESSAGE_CHECK = "Load Configure File into Configure Object"
!     CALL ESMF_LogWrite(MESSAGE_CHECK,ESMF_LOGMSG_INFO,rc=RC)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
...
!
      tend=timef()
      general_timer(1)%elapsed = general_timer(1)%elapsed         &
     &                           + (tend -tbeg)
...
!
      ...
      call ESMF_LogWrite(nuopcMsg, ESMF_LOGMSG_INFO)
      tend=timef()
      general_timer(2)%elapsed = general_timer(2)%elapsed         &
     &                           + (tend -tbeg)
...
!-----------------------------------------------------------------------
!
      use module_timers,only:print_timers
...
!
      ...
      ENDIF
      tend=timef()
      general_timer(12)%elapsed = general_timer(12)%elapsed         &
     &                           + (tend -tbeg)
      call print_timers
!
!-----------------------------------------------------------------------
