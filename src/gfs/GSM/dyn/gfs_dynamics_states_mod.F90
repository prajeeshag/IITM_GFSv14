...
!  P   Pegion  2016-06    Add attribute flags for coupler
!
!!USEs:
!
      USE ESMF
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='t_export',value=cf%temp_export,rc=rc1)
...
!--------------------------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='u_export',value=cf%u_export,rc=rc1)
...
!----------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='v_export',value=cf%v_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='p_export',value=cf%p_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='dp_export',value=cf%dp_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='dpdt_export',value=cf%dpdt_export,rc=rc1)
...
!-------------------------------------------------------
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='shum_wts_export',value=cf%shum_wts_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='sppt_wts_export',value=cf%sppt_wts_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='skebu_wts_export',value=cf%skeb_wts_export,rc=rc1)
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='skebv_wts_export',value=cf%skeb_wts_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='vcu_wts_export',value=cf%vc_wts_export,rc=rc1)
      CALL ESMF_AttributeSet(exp_gfs_dyn,name='vcv_wts_export',value=cf%vc_wts_export,rc=rc1)
