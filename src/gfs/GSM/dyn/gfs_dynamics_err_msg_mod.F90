...
!
      ...
      if(esmf_logfounderror(rc1, msg=msg)) then
          ...
          write(0,*) 'error happened in dynamics for ',msg,' ',var,' rc = ', rc1
          rc1     = esmf_success
      else
          if(lprint) write(0,*) 'pass in dynamics for ',msg,' ',var
      end if
      ...
      if(esmf_logfounderror(rc1, msg=msg)) then
          rc  = esmf_failure
          write(0,*) 'error happened in dynamics for ',msg, ' rc = ', rc1
          rc1 = esmf_success
      else
          if(lprint) write(0,*) 'pass in dynamics for ',msg
      end if
