...
!  2016/06/06           Philip Pegion,  add attribute flag for coupler
!
!!USEs:
!
      USE ESMF
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='t_export',value=cf%temp_export,rc=rc1)
...
!--------------------------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='u_export',value=cf%u_export,rc=rc1)
...
!----------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='v_export',value=cf%v_export,rc=rc1)
...
!---------------------------------------------------
      CALL ESMF_AttributeSet(exp_gfs_phy,name='tracer_export',value=cf%tracer_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='p_export',value=cf%p_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='dp_export',value=cf%dp_export,rc=rc1)
...
!-------------------------------------------------------
      ...
      CALL ESMF_AttributeSet(exp_gfs_phy,name='dpdt_export',value=cf%dpdt_export,rc=rc1)
