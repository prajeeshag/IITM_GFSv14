...
module ice_model_mod
  ...
  public :: ice_model_init, ice_model_end, ice_bottom_to_ice_top, update_ice_model_fast
...
contains
  ...
  subroutine update_ice_model_slow_dn ( Atmos_boundary, Land_boundary, Ice )
    ...
    call mpp_clock_begin(iceClock)
    call update_ice_model_slow (Ice, Land_boundary%runoff, Land_boundary%calving, Atmos_boundary%p )
    call mpp_clock_end(iceClock)
...
!! FOR now, simply set all to be the same:
  ...
  !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
  subroutine update_ice_model_slow (Ice, runoff, calving, p_surf)
